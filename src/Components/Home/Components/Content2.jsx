...
const FAQData = [
  ...
  },
  {
    question: "Lorem, ipsum dolor sit amet consectetur adipisicing?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur id numquam unde at, laudantium corporis.",
  },
  {
    question: "Lorem, ipsum dolor sit amet consectetur adipisicing?",
    answer:
      "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam hic eius odio.",
  },
  {
    question: "Lorem, ipsum dolor sit amet consectetur adipisicing?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus aliquid dicta id mollitia esse officiis sit qui voluptate tempore consequatur.",
  },
  {
    question: "Lorem, ipsum dolor sit amet consectetur adipisicing?",
    answer:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto tempora suscipit vel voluptatum nobis dolorum.",
  },
];
      ...
      <div className="py-[60px] px-5 md:py-24 md:px-12 w-full">
        <motion.div className="px-0 md:px-28">
          ...
          <p className="text-lg text-home-2 mt-10 md:mt-[60px] text-[32px] md:text-[38px] text-center md:text-left leading-8 md:leading-[42px]">
            ...
            architecto veritatis culpa. At, aliquam officiis?”
          </p>
          <motion.p
