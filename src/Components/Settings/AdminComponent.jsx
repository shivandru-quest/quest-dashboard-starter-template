  ...
  useEffect(() => {
    const getAdmins = async () => {
      ...
      let request = generalFunction.createUrl(
        ...
        }/admins?userId=${generalFunction.getUserId()}`
      );
      ...
      <div className="w-full flex items-center justify-between gap-4 mt-[24px]">
        ...
        <button
          ...
          style={{
            ...
            },${theme == "dark" ? "black" : "white"}) padding-box,${
          ...
          >
            ...
            >
              ...
              >
                ...
                <th
                  className="w-[25%] text-center py-[18px]"
                  style={{
                    color: bgColors[`${theme}-color-premitive-grey-9`],
                    background: bgColors[`${theme}-primary-bg-color-9`],
                  }}
                ...
                <th
                  className="w-[20%] text-center py-[18px] "
                  style={{
                    color: bgColors[`${theme}-color-premitive-grey-9`],
                    background: bgColors[`${theme}-primary-bg-color-9`],
                  }}
                ...
                <th
                  className="w-[10%] text-center py-[18px] "
                  style={{
                    color: bgColors[`${theme}-color-premitive-grey-9`],
                    background: bgColors[`${theme}-primary-bg-color-9`],
                  }}
                ...
                <th
                  className="w-[10%] px-6 py-[18px]  rounded-tr-xl"
                  style={{
                    color: bgColors[`${theme}-color-premitive-grey-9`],
                    background: bgColors[`${theme}-primary-bg-color-9`],
                  }}
